...
"""
text = "## 5. Pronóstico de consenso\n## 🤖 6. Informe Analítico Científico RAG\n" + original
val = ReportValidator(text, [])
val.check_numeric_prose()
for issue in val.issues:
    print(f"{issue.category} - {issue.evidence}")
if not val.issues:
    print("No issues found by check_numeric_prose on original block")
